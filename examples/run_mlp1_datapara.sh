...
CONFIG=""
SYNTHETIC=""
SYSTEM="${SCRIPT_DIR:?}"/../inputs/system/simple_torus_sys
WORKLOAD="${SCRIPT_DIR:?}"/../inputs/workload/mlp1_datapara
STATS="${SCRIPT_DIR:?}"/results/mlp1_datapara
...
then
	...
	NETWORK="${SCRIPT_DIR:?}"/../inputs/network/garnet/simple_torus
